...
var btnReset = document.querySelectorAll("#btnAdult, #btnAlcohol, #btnCannabis, #btnGaming, #btnTobacco, #btnAll, #btnVideo, #btnHide");
...
var btnReset = document.querySelectorAll("#btnAdult, #btnAlcohol, #btnCannabis, #btnGaming, #btnTobacco, #btnAll, #btnVideo");
for (var i=0;i<btnReset.length;i+=1){
  btnReset[i].style.backgroundColor = '#666';
}
...
var elemsShow = document.getElementsByClassName('galleryItem');
for (var i=0;i<elemsShow.length;i+=1){
  elemsShow[i].style.display = 'none';
}
var btnReset = document.querySelectorAll("#btnAdult, #btnAlcohol, #btnCannabis, #btnGaming, #btnTobacco, #btnAll, #btnVideo, #btnHide");
for (var i=0;i<btnReset.length;i+=1){
  btnReset[i].style.backgroundColor = '#666';
...
hideBtn.style.backgroundColor = "#82c240";
};
